...
const Icon: React.FC<IconProps> = ({ name, className, ...props }) => {
  const icons: { [key: string]: React.ReactNode } = {
    teacher: <path strokeLinecap="round" strokeLinejoin="round" d="M17 20h5v-2a3 3 0 00-5.356-1.857M17 20H7m10 0v-2c0-.656-.126-1.283-.356-1.857M7 20H2v-2a3 3 0 015.356-1.857M7 20v-2c0-.656.126-1.283.356-1.857m0 0a5.002 5.002 0 019.288 0M15 7a3 3 0 11-6 0 3 3 0 016 0zm6 3a2 2 0 11-4 0 2 2 0 014 0zM7 10a2 2 0 11-4 0 2 2 0 014 0z" />,
    ...
    exercise: <path strokeLinecap="round" strokeLinejoin="round" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.5L15.232 5.232z" />,
    answers: <path strokeLinecap="round" strokeLinejoin="round" d="M9 12l2 2 4-4m6 2a9 9 0 11-18 0 9 9 0 0118 0z" />,
    ...
    robot: <path strokeLinecap="round" strokeLinejoin="round" d="M9 3.782a2.25 2.25 0 01.944 4.304l-1.612 1.612A4.5 4.5 0 109 15a4.5 4.5 0 005.31-3.368l1.612-1.612a2.25 2.25 0 114.304-.944 2.25 2.25 0 01-4.304.944l-1.612 1.612A4.5 4.5 0 009 15a4.5 4.5 0 00-5.31 3.368l-1.612 1.612a2.25 2.25 0 11-4.304.944 2.25 2.25 0 014.304-.944l1.612-1.612A4.5 4.5 0 009 3.782zM15 5.25a.75.75 0 11-1.5 0 .75.75 0 011.5 0z" />,
    grammar: <path strokeLinecap="round" strokeLinejoin="round" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zm10 0a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
  };
